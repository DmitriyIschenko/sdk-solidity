...
contract PureFiSubscriptionService is AccessControlUpgradeable, AutomationCompatible, ISubscriptionOwner, ERC165 {
    ...
    address public subscriptionOwnerART;
    ...
    */
    ...
    function initialize(address _admin, address _ufi, address _tokenBuyer, address _profitCollectionAddress) public initializer {
        ...
        subscriptionOwnerART = _admin;
    }

    function setSubscriptionOwnerART(address newOwner) external onlyRole(DEFAULT_ADMIN_ROLE){
        subscriptionOwnerART = newOwner;
    }

    function getSubscriptionOwner() external view returns (address) {
        // the owner of the subscription must be an EOA
        // Replace this with the account created in Step 1
        return subscriptionOwnerART;
    }
